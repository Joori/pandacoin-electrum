...
class ElectrumWindow(QMainWindow):
    ...
    def init_menubar(self):
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("http://reddwallet.org"))
        help_menu.addSeparator()
        help_menu.addAction(_("&Documentation"), lambda: webbrowser.open("http://reddwallet.org/documentation.html")).setShortcut(QKeySequence.HelpContents)
